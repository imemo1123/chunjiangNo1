...
/**
 * Servlet implementation class GetHouseDetail
 */
public class GetHouseDetail extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("收到请求:getHouseDetail" );
		String result = null;
		...
		Map<String, String> rstList = HouseHandle.getHouseDetail(id);
